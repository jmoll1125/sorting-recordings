...
sorting-notes is intended to be run on a directory of iPhone voice memos. I extracted mine from an iTunes backup using MaxiHuHe04's excellent iTunes Backup Explorer. To extract your voice memos from a backup:
...
sorting-recordings is built to work with Stuart Langridge’s [sorttable](https://www.kryogenix.org/code/browser/sorttable/) JavaScript library. [Download a copy of sorttable](https://www.kryogenix.org/code/browser/sorttable/sorttable.js) and place it in the same directory as the file sorting-notes generated in order to enable sorting. Click a heading to sort by that data point; click it again to sort the other direction.
